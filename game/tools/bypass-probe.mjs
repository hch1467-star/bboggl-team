...
try {
   ...
   * 새 압력을 얹는 곳이 아닙니다.
   *
   * 그러니 남은 정직한 선택은 둘입니다 — 아직 **안 골랐습니다**:
   *   ⓐ 문턱의 뜻을 다시 적는다(궁수에게 한 것처럼). 「성수병 한 병」이
   *      아니라 *"걸어서 온 것보다 눈에 띄게 더 아프다"* — 실측으로
   *      **걸어서 29 vs 달려서 52**, 즉 **1.8배**입니다. 이 차이는
   *      크고 안정적이라 문턱으로 삼을 만합니다.
   *   ⓑ 지금 문턱을 그대로 두고, 값이 문턱을 자주 넘나드는 것을
   *      **기록으로** 안고 간다.
   * ⓐ 가 더 나아 보이지만, 그 전에 «걸어서 vs 달려서» 를 여러 판 재서
   *   1.8배가 흔들리는지부터 봐야 합니다 — 두 판으로 정할 값이 아닙니다.
   */
  /**
