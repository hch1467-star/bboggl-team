 ...
 *
 *     40m  금 간 벽   — *"수상하면 쳐 봐라"*
 *     72m  두꺼운 벽  — *"칼이 안 통하는 것도 있다. 통이 답이다"*
 *     80m  선반 위 보물 — **"손이 안 닿아도 답이 있다"**
 *
 * 답은 연쇄 하나뿐입니다: 길 위의 통 B 를 친다 → 불이 선반 위 통 A 로
 * 옮는다 → A 가 터지며 보물을 길 쪽으로 **밀어 떨어뜨립니다.**
 *
 * ⚠️ 여기 적힌 「80m · 선반」은 **처음 쓸 때 114m · 성벽이었습니다.**
 *    자리를 옮기고 이 머리말만 옛말로 남을 뻔했습니다 — 이 저장소가
 *    정련석 주석에서 겪은 그 드리프트입니다. 그래서 아래 검사는
 *    좌표를 **하나도 안 박고** 게임에게 물어서 찾습니다. 이 문단이
 *    또 낡아도 검사는 옳게 굴러갑니다.
 *
 ...
 *
 * ⚠️ 좌표를 여기 베껴 적지 않습니다. *"걸어갈 수 없는 보물"* 을 게임에게
 *    물어서 찾습니다 — 지도를 손보는 날 이 검사가 옛 자리를 지키지
 *    않도록.
 */
